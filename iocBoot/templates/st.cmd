...
#Record choices - for standard only double, longout or array
$$IF(DOUBLE_1)
...
$$ENDIF(LONGOUT_20)
$$LOOP(ARRAY_1)
dbLoadRecords("$(TOP)/db/array_1.db",    "HUTCH=$$HUTCH,$$IF(NELM,NELM=$$NELM,NELM=500),$$IF(FTYPE,FTYPE=$$FTYPE,FTYPE=DOUBLE),$$IF(EGU,EGU=$$EGU,),$$IF(PREC,PREC=$$PREC,),$$IF(INP,INP=$$INP,)")
$$ENDLOOP(ARRAY_1)
$$LOOP(ARRAY_10)
dbLoadRecords("$(TOP)/db/array_10.db",    "HUTCH=$$HUTCH,$$IF(NELM,NELM=$$NELM,NELM=500),$$IF(FTYPE,FTYPE=$$FTYPE,FTYPE=DOUBLE),$$IF(EGU,EGU=$$EGU,),$$IF(PREC,PREC=$$PREC,),$$IF(INP,INP=$$INP,)")
$$ENDLOOP(ARRAY_10)
$$LOOP(ARRAY_20)
dbLoadRecords("$(TOP)/db/array_20.db",    "HUTCH=$$HUTCH,$$IF(NELM,NELM=$$NELM,NELM=500),$$IF(FTYPE,FTYPE=$$FTYPE,FTYPE=DOUBLE),$$IF(EGU,EGU=$$EGU,),$$IF(PREC,PREC=$$PREC,),$$IF(INP,INP=$$INP,)")
$$ENDLOOP(ARRAY_20)
$$LOOP(HUTCH)
