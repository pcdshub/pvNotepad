...
$$ENDIF(LONGOUT_20)
$$LOOP(ARRAY_1)
dbLoadRecords("$(TOP)/db/array_1.db",    "HUTCH=$$HUTCH,$$IF(NELM,NELM=$$NELM,NELM=500)")
$$ENDLOOP(ARRAY_1)
$$LOOP(ARRAY_10)
dbLoadRecords("$(TOP)/db/array_10.db",    "HUTCH=$$HUTCH,$$IF(NELM,NELM=$$NELM,NELM=500)")
$$ENDLOOP(ARRAY_10)
$$LOOP(ARRAY_20)
dbLoadRecords("$(TOP)/db/array_20.db",    "HUTCH=$$HUTCH,$$IF(NELM,NELM=$$NELM,NELM=500)")
$$ENDLOOP(ARRAY_20)
