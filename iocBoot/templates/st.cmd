...
$$ENDIF(LONGOUT_20)
$$IF(ARRAY_1)
dbLoadRecords("$(TOP)/db/array_1.db",    "HUTCH=$$HUTCH")
$$ENDIF(ARRAY_1)
$$IF(ARRAY_10)
dbLoadRecords("$(TOP)/db/array_10.db",    "HUTCH=$$HUTCH")
$$ENDIF(ARRAY_10)
$$IF(ARRAY_20)
dbLoadRecords("$(TOP)/db/array_20.db",    "HUTCH=$$HUTCH")
$$ENDIF(ARRAY_20)

$$LOOP(SPECIAL)
dbLoadRecords("$(TOP)/db/specials.db",           "PV=$$PV,RECTYPE=$$RECTYPE")
$$ENDLOOP(SPECIAL)
# Setup autosave
